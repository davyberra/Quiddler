...
class PauseMenu(arcade.View):
    ...
    Pause Menu View.
    """
    def __init__(self, game_view, sound_list, sound_player):
        super().__init__()
        ...
        # Initialize list of sounds/background music player
    ...
    def on_mouse_release(self, x: float, y: float, button: int,
        ...
        if self.instructions_button in self.buttons_pressed:
            ...
            self.background_music.set_volume(volume=.25, player=self.sound_player)
        elif self.sound_off_button in self.buttons_pressed:
            self.background_music.set_volume(volume=0, player=self.sound_player)
    ...
    #         if self.background_music.get_volume(self.sound_player) != 0:
    #             self.background_music.set_volume(volume=0.0, player=self.sound_player)
    #         else:
    #             self.background_music.set_volume(volume=0.25, player=self.sound_player)
    #
    #     elif key == arcade.key.F8:
    #         if self.game_view.card_move_sound.get_volume(self.sound_player) != 0:
